...
(125,	'kalpesh',	'kalpesh',	'8989898989',	'k.p.tank.143@gmail.com',	'kalpesh',	'',	10,	8,	10,	395006,	0);
...
DROP TABLE IF EXISTS `art_subcategory2_master`;
CREATE TABLE `art_subcategory2_master` (
...
DROP TABLE IF EXISTS `art_subcategory_master`;
CREATE TABLE `art_subcategory_master` (
...
DROP TABLE IF EXISTS `suggestion_master`;
